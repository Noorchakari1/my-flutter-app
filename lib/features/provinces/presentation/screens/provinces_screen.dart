...
class _ProvincesScreenState extends ConsumerState<ProvincesScreen> {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('${_getText(context, "provinceLoadError")}: ${e.toString()}')),
        );
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    final provincesAsync = ref.watch(provinceNotifierProvider);
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              _getText(context, 'searchProvinces'),
                              style: TextStyle(
                                fontSize: 14,
                                color: isDark ? Colors.grey.shade400 : Colors.grey.shade600,
                              ),
                  ...
                  child: provincesAsync.when(
                    data: (provinces) {
                      if (_searchQuery.isNotEmpty) {
                        ...
                        provinces = _filterProvinces(provinces, _searchQuery);
                      }
                      ...
                      return RefreshIndicator(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: provinces.length + (_hasMoreData && _searchQuery.isEmpty ? 1 : 0),
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    _getText(context, 'provinceComingSoon'),
                    style: TextStyle(
                      fontSize: 14,
                      color: Colors.grey,
                    ),
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    _getText(context, 'provinceLoadError'),
                    style: TextStyle(
                      fontSize: 18,
                      fontWeight: FontWeight.w500,
  ...
  Widget _buildLoadingShimmer() {
    return ListView(
      ...
      children: [
        ...
        // Regular province item shimmers
        ...List.generate(
          5,
