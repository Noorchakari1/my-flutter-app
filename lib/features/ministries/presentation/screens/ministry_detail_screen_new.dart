...
class MinistryDetailScreen extends BaseDetailScreen<MinistryItem> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              LocalizationHelper.getText(ref, 'ministryLoadError'),
              style: TextStyle(
                fontSize: 18,
                ...
                if (ministry.image != null && ministry.image!.isNotEmpty)
                  CachedNetworkImage(
                    ...
                    errorWidget: (context, url, error) => Container(
                      ...
                      child: const Center(
                        child: Icon(Icons.account_balance, size: 80, color: Colors.grey),
                      ),
                    ),
                  )
                else
            ...
            IconButton(
              ...
              onPressed: () {
                if (ministry.link != null && ministry.link!.isNotEmpty) {
                  launchURL(context, ministry.link);
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ministry.title ?? LocalizationHelper.getText(ref, 'ministry'),
                        style: TextStyle(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                          height: 1.4,
                      ...
                      const SizedBox(height: 16),
                      _buildMetadataRow(context, ministry),
                    ],
                  ),
                ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (ministry.phone != null && ministry.phone!.isNotEmpty)
                          InkWell(
                            onTap: () => makePhoneCall(context, ministry.phone),
                            child: Padding(
                        ...
                        if (ministry.link != null && ministry.link!.isNotEmpty)
                          InkWell(
                            onTap: () => launchURL(context, ministry.link),
                            child: Padding(
                              padding: const EdgeInsets.symmetric(vertical: 8),
                              child: Row(
                                children: [
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                              LocalizationHelper.getText(ref, 'aboutMinistry'),
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: isDarkMode ? Colors.white : Colors.black87,
                  ...
                  child: Row(
                    ...
                    children: [
                      _buildActionButton(
                        ...
                        onTap: () => makePhoneCall(context, ministry.phone),
                        enabled: ministry.phone != null && ministry.phone!.isNotEmpty,
                      ),
                      _buildActionButton(
                        context,
                        icon: Icons.language,
