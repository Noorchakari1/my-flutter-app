      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _getText(context, ref, 'ministryLoadError'),
              style: TextStyle(
                fontSize: 18,
            ...
            const SizedBox(height: 24),
            ElevatedButton.icon(
              onPressed: () => ref.refresh(ministryDetailProvider(ministryId)),
            ...
            IconButton(
              ...
              onPressed: () {
                if (ministry.link != null && ministry.link!.isNotEmpty) {
                  _launchURL(context, ministry.link);
                } else {
                  ScaffoldMessenger.of(context).showSnackBar(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ministry.title ?? _getText(context, ref, 'ministry'),
                        style: TextStyle(
                          fontSize: 22,
                          fontWeight: FontWeight.bold,
                          height: 1.4,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                              _getText(context, ref, 'aboutMinistry'),
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: isDarkMode ? Colors.white : Colors.black87,
